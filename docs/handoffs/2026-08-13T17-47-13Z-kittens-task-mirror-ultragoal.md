...
- **Immediate next best action:** `/ultragoal start @docs/plans/2026-08-13-ultragoal-observability.md`. Step 2 of that skill is the single HITL gate; after the user confirms the check table, autonomy begins and the Stop hook will refuse to let the session stop.
